...
const ProductGrid = () => {
  return (
    <div className="container mx-auto px-4 py-8">
      <h2 className="text-4xl font-bold text-center mb-12 text-[#000000]">Related Products</h2>

      <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6 md:ml-[5rem]">
        {products.map((product, index) => (
          ...
          >
            ...
            {product.discount && (
              <span className="absolute top-2 left-3/4 md:left-1/2 bg-red-500 text-white text-xs font-semibold px-2 py-1 rounded-full">
                -{product.discount}
              </span>
            )}
            <div className="p-4">
